...
enum auto WHITEPOINT_X = 0.950456;
enum auto WHITEPOINT_Y = 1.0;
enum auto WHITEPOINT_Z = 1.0088754;

/* struct for representing a color transform */
